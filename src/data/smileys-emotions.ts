...
export const faceAffection = `1F970                                                  ; fully-qualified     # 🥰 E11.0 smiling face with hearts
...
export const faceTongue = `1F60B                                                  ; fully-qualified     # 😋 E0.6 face savoring food
...
export const faceHand = `1F917                                                  ; fully-qualified     # 🤗 E1.0 smiling face with open hands
...
export const faceNeutralSkeptical = `1F910                                                  ; fully-qualified     # 🤐 E1.0 zipper-mouth face
...
export const faceSleepy = `1F60C                                                  ; fully-qualified     # 😌 E0.6 relieved face
...
export const faceUnwell = `1F637                                                  ; fully-qualified     # 😷 E0.6 face with medical mask
...
export const faceHat = `1F920                                                  ; fully-qualified     # 🤠 E3.0 cowboy hat face
1F973                                                  ; fully-qualified     # 🥳 E11.0 partying face
1F978                                                  ; fully-qualified     # 🥸 E13.0 disguised face`

export const faceGlasses = `1F60E                                                  ; fully-qualified     # 😎 E1.0 smiling face with sunglasses
1F913                                                  ; fully-qualified     # 🤓 E1.0 nerd face
1F9D0                                                  ; fully-qualified     # 🧐 E5.0 face with monocle`

export const faceConcerned = `1F615                                                  ; fully-qualified     # 😕 E1.0 confused face
...
export const faceNegative = `1F624                                                  ; fully-qualified     # 😤 E0.6 face with steam from nose
...
export const faceCostume = `1F4A9                                                  ; fully-qualified     # 💩 E0.6 pile of poo
...
export const catFace = `1F63A                                                  ; fully-qualified     # 😺 E0.6 grinning cat
...
export const monkeyFace = `1F648                                                  ; fully-qualified     # 🙈 E0.6 see-no-evil monkey
1F649                                                  ; fully-qualified     # 🙉 E0.6 hear-no-evil monkey
1F64A                                                  ; fully-qualified     # 🙊 E0.6 speak-no-evil monkey`

export const heart = `1F48C                                                  ; fully-qualified     # 💌 E0.6 love letter
...
export const emotion = `1F48B                                                  ; fully-qualified     # 💋 E0.6 kiss mark
